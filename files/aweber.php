...
require_once('files/aweber_api/aweber_api.php');

// Step 1: assign these values from https://labs.aweber.com/apps
$consumerKey = 'AkMSyeqENrkM5vrkk12RNShP';
$consumerSecret = 'es5dfK92Gx6mtlvq1yz35EtS8SBvNw9GGqBsNEnt';

// Step 2: load this PHP file in a web browser, and follow the instructions to set
// the following variables:
$accessKey = 'Ag3JsAgUSjNQmLmKPc1taSGA'; 
$accessSecret = 'WHnoGjGcT2IpnxYAlHZ4rwYvawmS5ICePPsKEw4q'; 
$list_id = '';
